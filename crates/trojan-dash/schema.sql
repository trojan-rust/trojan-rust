-- Schema for trojan-dash. Applied at startup, and by POST /admin/migrate.
--
-- Column types are unchanged from the Cloudflare D1 original so an export of
-- that database imports here as-is.

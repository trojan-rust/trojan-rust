...
- validate on every start path, and put config enums in the type system


### Chores

- ignore Claude Code's transient state


### Documentation

- read the admin token from an environment file


### Features

- chart traffic over a chosen window, at the resolution it has
...
## [0.10.0](https://github.com/trojan-rust/trojan-rust/compare/v0.9.1...v0.10.0) - 2026-04-28

### Bug Fixes

- satisfy clippy 1.95 lints in ws inspect/accept

- make traffic batching durable, accurate, and SWR-safe


### Features

- expose batch flush interval in HTTP auth config
